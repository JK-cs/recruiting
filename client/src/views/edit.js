  ...
  render() {
    return (
      <div>
        ...
        <div className="editTitle">지원자 정보 수정</div>
        <div>
          <div className="formcontainer">
            ...
            >
              <div className="form-group">
                <label className="formlabel">성명</label>
                <input
                  type="text"
                  className="input1"
              ...
              <div className="form-group">
                <label className="formlabel">이화이언 아이디</label>
                <input
                  type="text"
                  className="input2"
              ...
              <div className="form-group">
                <label className="formlabel">팀</label>
                <input
                  type="text"
                  className="input3"
              ...
              <div className="form-group">
                <label className="formlabel">합격여부</label>
                <input
                  type="text"
                  className="input4"
              ...
              <div className="form-group">
                <label className="formlabel">키값</label>
                <input
                  type="text"
                  className="input1"
