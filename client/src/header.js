...
function Header() {
  ...
  useEffect(
    (e) => {
      if (currentClick === "apply" || currentClick === "result") {
      ...
      if (prevClick === "apply" || prevClick === "result") {
  ...
  return (
    <div id="headerBox" className="headerBox">
      <Link to="/" className="logoA">
        <img className="logoImg" id="main" src="/img/logo.svg" alt="ewhaian" />
      </Link>
      <Ul id="headerUl" className="headerUl">
        <Li id="apply_1">
          <Link to="/applyClosed" id="apply" onClick={GetClick}>
            지원하기
          </Link>
        </Li>
        <Li id="result_1">
